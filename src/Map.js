    ...
    <>
        <Router>
          <Routes>
            ...
            <Route path="/gender-prompt" element={<GenderPrompt />} />
            <Route path="/biometrics" element={ <Biometrics />} />
            <Route path="/weekly-goals" element={ <WeeklyGoals />} />
            <Route path="/workout-plans" element={ <WorkoutPlans/>} />
            <Route path="/workout-plans/:workout_id/week/list" element={<WeeklyRoutine />} />
            <Route path="/workout-plans/:workout_id/week/day/:day_id/list" element={ <Exercises/>} />
          </Routes>
        </Router>
    </>
    )
